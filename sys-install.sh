...
pacman -Sy
pacstrap /mnt base linux-zen linux-zen-headers base-devel xf86-video-amdgpu libva-mesa-driver xf86-video-vesa vulkan-radeon mesa-vdpau linux-firmware sudo nano refind dhcpcd networkmanager
